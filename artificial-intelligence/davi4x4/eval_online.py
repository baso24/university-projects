...
from environment import generate_solvable_state, GRID_SIZE_15
...
def evaluate_online():
    ...
    problems = [generate_solvable_state(GRID_SIZE_15) for _ in range(NUM_PROBLEMS)]
    print(f"Evaluating on {NUM_PROBLEMS} random solvable 15-puzzles...\n")
