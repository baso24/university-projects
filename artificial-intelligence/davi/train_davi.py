...
ITERATIONS = 2000
BATCH_SIZE = 1000
MAX_SCRAMBLE = 30       # training boards are scrambled 1..MAX_SCRAMBLE moves from the goal
LEARNING_RATE = 0.001
SYNC_EVERY = 50         # how often the frozen target network catches up to the live one
...
def train_davi():
    ...
    print(f"Training DAVI for the 8-puzzle on {device}")
    ...
    for iteration in range(1, ITERATIONS + 1):
        states = [scramble_from_goal(random.randint(1, MAX_SCRAMBLE)) for _ in range(BATCH_SIZE)]
