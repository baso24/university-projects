...
def get_dataloaders(batch_size=1):
    ...
    train_path = os.path.join(current_directory, "train_dataset.csv")
    val_path = os.path.join(current_directory, "val_dataset.csv")
    test_path = os.path.join(current_directory, "test_dataset.csv")
